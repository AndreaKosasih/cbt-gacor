<template>
    <Head>
        <title>Tambah Mahasiswa - Aplikasi Ujian Online</title>
    </Head>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Tambah Mahasiswa</h5>
                        <hr>
                        <form @submit.prevent="submit">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label>Npm</label> 
                                        <input type="text" class="form-control" placeholder="Masukkan Npm Mahasiswa" v-model="form.npm">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan Nama Mahasiswa" v-model="form.name">
